...
<head>
	<script>
        ...
        function fn_goDetail(seq) {
	        location.href="/board-detail?seq="+seq+"&page=gallery&pageNum="+pageNum;
        }
         ...
         */
        function fn_goWrite(){
	        location.href="/admin/page-board-write?page=gallery";
        }
            ...
            if( list.length !== 0 ){
                list.forEach (function (el, index) {
                    ...
                    div.append('<div class="col mb-5 mb-md-0" onclick="fn_goDetail('+el.SEQ+');">'
								...
								+ '<img class="card-img" src="'+el.MAIN_IMG_PATH+'" alt="" style="max-height:300px;min-height:300px;">'
								+ '</div>'
								+ '<div class="card-body">'
	                            + '<h4>'+el.EDT_TITLE+'</h4>'
	...
	<div class="row">
		...
		<div class="col-md-9 col-lg-10" >
			...
			<div class="container content-space-1">
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3" id="div-list">
				</div>
				<!-- End Row -->
			</div>
			<!-- End Card Grid -->
